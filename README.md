...
[![PyPI](https://img.shields.io/pypi/v/taskuary.svg?cacheSeconds=300&release=0.3.5.1&asof=2026-09-16c)](https://pypi.org/project/taskuary/)
...
Taskuary is early—currently **v0.3.5.1**—so breaking changes are still possible before 1.0.
