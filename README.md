...
[![PyPI](https://img.shields.io/pypi/v/taskuary.svg?cacheSeconds=300&release=0.3.4.8&asof=2026-09-14b)](https://pypi.org/project/taskuary/)
...
Taskuary is early—currently **v0.3.4.8**—so breaking changes are still possible before 1.0.
