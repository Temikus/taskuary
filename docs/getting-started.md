...
3. **A coding CLI.** Choose a preset for Claude Code, Codex, Qwen Code, OpenCode, Kimi Code, Gemini, Cursor, Copilot, or
   ...
   For DeepSeek, GLM, MiniMax, or Kimi, follow [Chinese-model coding CLIs](chinese-coding-clis.md).
